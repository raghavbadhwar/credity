...
export default function Dashboard() {
  ...
  const { data: stats, isLoading: statsLoading } = useQuery<{ stats: VerificationStats }>({
    ...
    refetchInterval: 60000, // ⚡ Bolt: Extended refetch interval to reduce unnecessary API calls and re-renders
  });
  ...
  const { data: recentData, isLoading: recentLoading } = useQuery<{ results: VerificationRecord[] }>({
    ...
    refetchInterval: 30000, // ⚡ Bolt: Extended refetch interval to reduce unnecessary API calls and re-renders
  });
