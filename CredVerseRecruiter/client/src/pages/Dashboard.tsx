...
export default function Dashboard() {
  ...
  const { data: stats, isLoading: statsLoading } = useQuery<{ stats: VerificationStats }>({
    ...
    refetchInterval: 60000, // ⚡ Bolt: Extended from 10s to 60s to reduce unnecessary API load and React re-renders
  });
  ...
  const { data: recentData, isLoading: recentLoading } = useQuery<{ results: VerificationRecord[] }>({
    ...
    refetchInterval: 30000, // ⚡ Bolt: Extended from 5s to 30s to reduce unnecessary API load and React re-renders
  });
