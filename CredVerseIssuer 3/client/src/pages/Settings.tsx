                                ...
                                <div className="p-4 border rounded-lg space-y-4">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <Input
                                            ...
                                            className="font-mono"
                                        />
                                        <Button variant="outline" size="icon" aria-label="Copy API Key" onClick={handleCopyApiKey}>
                                            {copiedKey ? <Check className="h-4 w-4 text-green-600" /> : <Copy className="h-4 w-4" />}
                                        </Button>
                                        <Button variant="outline" size="icon" aria-label="Rotate API Key" onClick={handleRotateApiKey}>
