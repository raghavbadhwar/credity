...
// Optimized: Memoized component to prevent unnecessary re-renders when parent state changes.
export const CredentialListItem = memo(({ cred, index }: CredentialListItemProps) => {
  return (
