              ...
              <CardContent className="p-6 space-y-4">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex justify-between py-2 border-b border-border">
                    ...
                    <button onClick={handleCopyHash} className="flex items-center gap-1 text-primary hover:underline" aria-label="Copy hash to clipboard" title="Copy hash to clipboard">
