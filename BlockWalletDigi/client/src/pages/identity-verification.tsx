...
export default function IdentityVerification() {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'liveness' | 'biometrics' | 'documents'>(
    'overview',
  );
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
              ...
              <p className="text-muted-foreground max-w-lg">
                build your reputation across the CredVerse network. Verify your biometrics and
                documents to unlock high-trust services.
              </p>
            </div>
            ...
            <div className="flex items-center gap-6 bg-card/50 p-4 rounded-2xl border backdrop-blur-sm">
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-1.5 text-xs text-muted-foreground">
                  ...
                  <span>
                    {verificationScore >= 80 ? 'Maximally Trusted' : 'Complete steps to upgrade'}
                  </span>
                </div>
              </div>
            </div>
                ...
                <div className="bg-card p-6 rounded-xl border">
                  ...
                  {!livenessSession ? (
                    <div className="text-center py-8">
                      ...
                      <Button onClick={handleStartLiveness} disabled={cameraActive}>
                        {cameraActive ? (
                        ...
                        {livenessSession.challenges?.map((c: Challenge, i: number) => {
                          const isCompleted =
                            ...
                            (livenessSession.challenges?.findIndex(
                              (ch: Challenge) => ch.id === currentChallenge?.id,
                            ) || 0);
                    ...
                    <div className="group relative p-6 rounded-xl border bg-card/50 hover:border-primary/50 transition-all duration-300 hover:shadow-lg cursor-pointer overflow-hidden">
                      ...
                      <div className="relative z-10">
                        ...
                        <Button
                          className="w-full"
                          variant={
                            status?.biometrics?.type === 'fingerprint' ? 'secondary' : 'default'
                          }
                    ...
                    <div className="flex items-start gap-6 p-6 bg-gradient-to-br from-blue-600/5 to-blue-600/10 border border-blue-200/50 dark:border-blue-500/20 rounded-2xl relative overflow-hidden">
                      ...
                      <div className="flex-1 relative z-10">
                        ...
                        <p className="text-sm text-muted-foreground leading-relaxed mb-4">
                          Securely fetch and verify your government-issued documents directly from
                          the source. Uses W3C Verifiable Credentials standard.
                        </p>
