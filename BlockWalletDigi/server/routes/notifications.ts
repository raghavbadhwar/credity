...
router.post('/push', async (req, res) => {
  try {
    const { issuerId, issuerName, recipientDid, recipientEmail, credential, expiryHours } =
      req.body;
    ...
    const result = await pushCredentialToWallet(issuerId, issuerName, recipientDid, credential, {
      recipientEmail,
      expiryHours,
    });
