...
const PORTAL_URLS = {
  ...
  issuer: (import.meta as any).env.VITE_ISSUER_URL || 'http://localhost:5001',
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  wallet: (import.meta as any).env.VITE_WALLET_URL || 'http://localhost:5002',
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  recruiter: (import.meta as any).env.VITE_RECRUITER_URL || 'http://localhost:5003',
};
