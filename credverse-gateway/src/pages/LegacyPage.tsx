...
// Google icon component (outside component to avoid recreating on each render)
function GoogleIcon() {
  return (
...
// This is the original demo preserved at /legacy route
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
      <header className="px-6 py-4 bg-white border-b border-gray-200 flex justify-between items-center">
        ...
        <nav className="text-sm font-medium text-gray-500 hidden md:block">
          Secure Identity Gateway v1.0 (Legacy Demo)
        </nav>
      </header>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid gap-4">
                    <input 
                      ...
                      className="flex h-10 w-full rounded-md border border-gray-300 bg-transparent px-3 py-2 text-sm placeholder:text-gray-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-900 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50" 
                      disabled 
                    />
                    <button 
                      disabled 
                      className="w-full h-10 bg-gray-900 text-white rounded-lg font-medium text-sm opacity-50 cursor-not-allowed"
                    >
                      Sign In
                    </button>
                  </div>
